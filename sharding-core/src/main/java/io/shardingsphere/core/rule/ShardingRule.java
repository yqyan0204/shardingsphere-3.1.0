...
import io.shardingsphere.core.routing.filter.DataSourceTableFilter;
import io.shardingsphere.core.routing.filter.DefaultDataSourceTableFilter;
...
public class ShardingRule {
    ...
    private final DataSourceTableFilter defaultDataSourceTableFilter;
    ...
    public ShardingRule(final ShardingRuleConfiguration shardingRuleConfig, final Collection<String> dataSourceNames) {
        ...
        defaultDataSourceTableFilter = null == shardingRuleConfig.getDefaultDataSourceTableFilter() ? new DefaultDataSourceTableFilter() : shardingRuleConfig.getDefaultDataSourceTableFilter();
