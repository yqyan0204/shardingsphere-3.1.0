...
import io.shardingsphere.core.routing.filter.DataSourceTableFilterFactory;
...
public class YamlShardingRuleConfiguration {
    ...
    private String defaultDataSourceTableFilterClassName;
    ...
    public YamlShardingRuleConfiguration(final ShardingRuleConfiguration shardingRuleConfiguration) {
        ...
        defaultDataSourceTableFilterClassName =  null == shardingRuleConfiguration.getDefaultDataSourceTableFilter() ? null : shardingRuleConfiguration.getDefaultDataSourceTableFilter().getClass().getName();
    }
    ...
    public ShardingRuleConfiguration getShardingRuleConfiguration() {
        ...
        if (null != defaultDataSourceTableFilterClassName) {
            result.setDefaultDataSourceTableFilter(DataSourceTableFilterFactory.newInstance(defaultDataSourceTableFilterClassName));
        }
